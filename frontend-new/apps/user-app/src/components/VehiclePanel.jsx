...
const VehiclePanel = (props) => {
    ...
    return (
        <div className="w-full h-full bg-white rounded-t-2xl sm:rounded-t-3xl shadow-2xl overflow-y-auto"> {/* CHANGED: Removed inline styles */}
                                ...
                                <div className="relative flex-shrink-0">
                                    ...
                                    <img
                                        ...
                                        onError={(e) => {
                                            ...
                                            e.target.src = "https://via.placeholder.com/80x80/cccccc/ffffff?text=Vehicle";
                                        }}
                                    />
