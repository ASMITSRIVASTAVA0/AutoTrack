...
const RoutePreloader = () => {
  ...
  //       } 
  //       else if(currentPath==="/captains/login"){
  //         await Promise.all([
  //           import("../pages.signup/CaptainSignup.jsx"),
  //           import("../pages.home/CaptainHome.jsx"),
  //           import("../pages.home/CAPTAIN/riding/CaptainRiding.jsx")
  //         ]);
  ...
  //           import("../pages.home/USER/riding/Riding.jsx")
  ...
  //       } else if (currentPath === '/home' || currentPath === '/captains/home' || currentPath === '/parents/home') {
  //         // Preload riding and logout components
  //         await Promise.all([
  //           import('../pages.home/CAPTAIN/riding/CaptainRiding.jsx'),
  //           import("../pages.home/CAPTAIN/riding/FinishRide.jsx"),
  //           import('../pages.home/USER/riding/Riding.jsx'),
  ...
  //     } else if (currentPath === '/captains/login') {
  //       routesToPrefetch.push('/captains/signup');
  //     } else if (currentPath === '/parents/login') {
  //       routesToPrefetch.push('/parents/signup');
  //     }
