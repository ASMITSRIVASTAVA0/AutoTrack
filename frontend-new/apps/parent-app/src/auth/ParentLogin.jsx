...
//     try {
//       const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/parents/login`, {
//         email: email,
//         password: password
//       })
...
//           <Link to='/parents/signup' className='text-purple-600 font-semibold hover:text-purple-700'>
//             Sign up here
//           </Link>
//         </p>
...
import { Link, useNavigate } from 'react-router-dom'
import axios from 'axios'
import { ParentDataContext } from './ParentContext'
...
const ParentLogin = () => {
  ...
  const handleSignupClick = () => {
    console.log('Navigating to /parents/signup')
    navigate("/parents/signup");
  }
        ...
        <div className='max-w-md mx-auto w-full flex-1 flex flex-col justify-center'>
          ...
          >
            <div className='inline-flex items-center gap-2 mb-4'>
              ...
              <h1 className='text-3xl sm:text-4xl font-bold text-white'>Parent Login</h1>
            </div>
            <p className='text-zinc-400 text-base sm:text-lg'>Monitor your child's safe travel</p>
          </div>
