...
//     try {
//       const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/parents/register`, newParent)
...
//           <Link to='/parents/login' className='text-purple-600 font-semibold hover:text-purple-700'>
//             Login here
//           </Link>
//         </p>
...
import axios from 'axios'
import { ParentDataContext } from '../pages.home/PARENT/ParentContext'
...
const ParentSignup = () => {
  ...
  const handleLoginClick = () => {
    console.log('Navigating to /parents/login')
