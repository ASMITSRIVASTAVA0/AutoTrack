...
const ConfirmRidePopUp = (props) => {
    ...
    const submitHander = async (e) => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                navigate('/captains/users/riding', { state: { ride: response.data.ride || props.ride } })
            }
        } catch (error) {
    ...
    const confirmRidePopupPanelRef=props.confirmRidePopupPanelRef;
                        ...
                        <div className='mt-6 w-full'>
                            <form onSubmit={submitHander}>
                                <input 
                                    ...
                                    type="text" 
                                    className='text-black bg-[#eee] px-6 py-4 font-mono text-lg rounded-lg w-full mt-3' 
