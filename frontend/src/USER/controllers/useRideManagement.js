...
const useRideManagement = ({
  ...
  const createRide = async () => {
    ...
    const rideData = {
      ...
      fare:fare//dont calc again at ride.service.js in backend, if createride called, then calc fare must be called previously
    };

    console.log("Sending ride data,pickup="+pickup+" dest="+destination," vehicletype="+vehicleType+" fare="+fare);
    ...
    try {
      ...
      return response.data;//this will have{message:"",ride:}
