...
import { useHomeController } from './controller.user/index.js';
import { Animation } from '../component.user/Animation.js';

// Lazy load components
const ConfirmRide = lazy(() => import('../component.user/ConfirmRide.jsx'));
const LookingForDriver = lazy(() => import('../component.user/LookingForDriver.jsx'));
const WaitingForDriver = lazy(() => import('../component.user/WaitingForDriver.jsx'));
const NotificationToast = lazy(() => import('../component.user/NotificationToast.jsx'));
const ParentRequestsPanel = lazy(() => import('../component.user/ParentRequestsPanel.jsx'));

// Regular imports
import ParentMenu from '../component.user/ParentMenu.jsx';
import VehiclePanel from '../component.user/VehiclePanel.jsx';
import BottomFormPanel from '../component.user/BottomFormPanel.jsx';
import StaticMapBg from '../component.user/StaticMapBg.jsx';
        ...
        <div className='h-screen bg-gradient-to-b from-gray-900 via-black to-blue-900 relative overflow-hidden'>
            ...
            <Suspense fallback={
                ...
                <BottomFormPanel
                    ...
                    calcFare={controller.calcFare}//main==================================================
