...
//             <div 
//             className='flex items-center justify-between p-4 border-2 border-yellow-400 rounded-lg mt-4'>
//                 <div 
...
//                     <h2 className='text-lg font-medium'>User firstname: {props.ride?.user.fullname.firstname}</h2>
//                 </div>
